    ...
    <header className='font-sans pb-3 md:pb-0 border-b border-separator '>
        ...
        <nav className=' container md:flex md:justify-between items-center p-1'>
            ...
            <ul className='flex gap-3 text-sm md:text-base justify-center md:gap-5 items-center [&>*:not(:last-child):hover]:underline'>
                ...
                <Link to='/finalizar' className='md:border inline md:py-2 md:px-3 hover:bg-charcoal hover:text-off-white hover:transition'><a href="">Carrinho <span className='border rounded-4xl p-[5px] md:py-1 md:px-2 text-center bg-peach text-off-white'>{count}</span></a></Link>
            </ul>
        </nav>
    </header>
  )
